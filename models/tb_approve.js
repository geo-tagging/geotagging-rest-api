...
module.exports = (sequelize, DataTypes) => {
  class tb_approve extends Model {
    ...
    static associate(models) {
      ...
      tb_approve.belongsTo(models.tb_petakUkur, { foreignKey: "id_petak" });
      tb_approve.belongsTo(models.tb_sk, { foreignKey: "id_sk" });
      tb_approve.belongsTo(models.tb_skKerja, {
        foreignKey: "id_skKerja",
      });
      tb_approve.belongsTo(models.tb_status, { foreignKey: "id_status" });
      tb_approve.belongsTo(models.tb_statusAreaTanam, {
  ...
  tb_approve.init(
    {
      ...
      id_skKerja: DataTypes.INTEGER,
      id_status: DataTypes.INTEGER,
      id_statusAreaTanam: DataTypes.INTEGER,
